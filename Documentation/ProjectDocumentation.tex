...
We believe that the hardest part of this project for now will be creating a reliable system for reminders and events. This might require making the progam runnable in the background and adding Windows reminders for the user in the fashion of the notifications that you receive in the bottom right in Windows 10.
