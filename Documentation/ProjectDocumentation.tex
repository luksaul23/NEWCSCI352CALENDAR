...
\hline
3 & Add task to TODO List & User & Med & 1\\
\hline
4 & Remove task from TODO List& User & Med & 1\\
\hline
5 & Check off a task from the TODO List & User & Med & 2\\
\hline
\hline
...
\item[Description:] A user has either made an error in adding an event or an event has passed and they need to remove it. They will click on the Remove Event button which will begin the process for removing an event from the calendar.
\end{itemize}
...
\begin{figure}[ht!]
\includegraphics[height=250px, width=450px]{MockUp_2.png}
\caption{First picture of an interface mockup}
\label{mockup1}
\end{figure}
