...
\begin{figure}[ht!]
\includegraphics[height=250px, width=450px]{Capture.jpg}
\caption{Picture of the interface}
\label{mockup1}
\end{figure}

Here the user is greeted with the main screen. Calendar on the left and TODO list on the right. The month can be changed using the dropbox to the upper right of the calendar and events can be added or removed using the buttons to the bottom right of the calendar. Tasks can be added to the TODO list via the button and text box below the TODO list area, tasks are removed when the checkbox has been checked. \ref{mockup1}

Event Addition \ref{addEvent}
\begin{figure}[ht!]
\includegraphics[height=250px, width=200px]{Capture1.jpg}
\caption{Picture of the event addition interface}
\label{addEvent}
\end{figure}

Here a user may add an event to the calendar by inputting the information into the textboxes and clicking Add Event. \ref{addEvent}

Event Removal \ref{removeEvent}
\begin{figure}[ht!]
\includegraphics[height=250px, width=200px]{Capture2.jpg}
\caption{Picture of the event removal interface}
\label{removeEvent}
\end{figure}

Here a user may remove an event fromt the calendar by putting the event's information into the textboxes and clicking Remove Event. \ref{removeEvent}
...
\begin{figure}[ht!]
\includegraphics[scale=.3]{UML1.jpeg}
