...
This project will be finished once user can be store an event/reminder and be successfully reminded of the event they added to the calendar correctly and perhaps synchronize it to their google calendar. We also want to have a number of customization option available to the user to make the program look how they want it to look, which would look like customizable background colors/pictures and layouts.
...
\item Ability to alter the aesthetic of the program via background pictures, colors, sizes, layout.
\item Ability to add a "reminder" or short term event, and be notified of its happening on the desktop.
\end{itemize}
