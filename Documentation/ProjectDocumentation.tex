...
\title{Final Project Documentation Starter\\ for UTM CSCI 352 Fall 2018}
%
%
...
\begin{abstract}
Our intention with this project is to create a central hub for events, reminders, weather, etc. for someone. 
\end{abstract}
...
Our goals for this program is to create a calendar system that will integrate locally stored events and reminders with Google Calendar and others. We expect the target users to run the program at startup so that they can be reminded of their schedules, weather forecasts, reminders, etc. so they may be kept on track and prepare for the day. We hope that people will find that their lives are made a little easier having this program reminding them of what they need to do.
...
This program will be fairly similar to google calendars or windows calendars even but much more customizable. A lot of people have stuggled with keeping everything they need to get done in a day straight in their mind, we know we have. Which is why we'll be creating this solution so that ourselves and others may have another thing to help keep them on track.

\subsection{Challenges}
We believe that the hardest part of this project for now will be creating a reliable system for reminders and events. This might require making the progam runnable in the background and adding windows reminders for the user.

\section{Scope}

This project will be finished once someone can be reminded of an event they added to the calendar correctly and perhaps add is to their google calendar. We also want to have a number of customization option available to the user to make the program look how they want it to look.
